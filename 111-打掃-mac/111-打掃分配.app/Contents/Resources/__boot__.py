...
_path_inject(['/Volumes/drive/GoogleDrive/Python/SideProject/assignment'])
...
DEFAULT_SCRIPT='/Volumes/drive/GoogleDrive/Python/SideProject/assignment/webview_.py'
SCRIPT_MAP={}
try:
    _run()
